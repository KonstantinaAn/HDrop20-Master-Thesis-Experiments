...
class DeterministicUSM:
    ...
    def run(self):
        ...
        k_constraint_counter = 0
        for element in self.elements:
            self.logger.info("Item DeterministicUSM: {}, k: {}, k_now: {}".format(element, self.k, k_constraint_counter))
