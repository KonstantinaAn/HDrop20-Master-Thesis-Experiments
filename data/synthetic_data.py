    ...
    def create_worker_tasks(self, popular_ratio=None, distribution=None):
        ...
        if distribution is None:
            ...
            for worker in self.workers:
                ...
                print('num_non_popular_tasks', num_popular_tasks)
                num_non_popular_tasks = num_tasks - num_popular_tasks
                print('num_popular_tasks', num_non_popular_tasks)
...
if __name__ == "__main__":
    synth_data = SyntheticData(20, 20,popular_ratio=0.18, json_path='', seed=2021)
    costs_range = (1, 25)
    ...
    synth_data.dataframe_to_csv(tasks_df, 'tasks',
                                path=r'C:\Users\Konstantina\Desktop\HDrop20-master-thesis-experiments\data\data_files\\')
    synth_data.dataframe_to_csv(worker_df, 'workers',
                                path=r'C:\Users\Konstantina\Desktop\HDrop20-master-thesis-experiments\data\data_files\\')
    synth_data_2 = SyntheticData(20, 20,popular_ratio=0.18, json_path='', seed=2020)
    ...
    synth_data_2.dataframe_to_csv(worker_df_2, 'workers_2',
                                path=r'C:\Users\Konstantina\Desktop\HDrop20-master-thesis-experiments\data\data_files\\')
    synth_data_3 = SyntheticData(20, 20,popular_ratio=0.18, json_path='', seed=2019)
    ...
    synth_data_4 = SyntheticData(20, 20, popular_ratio=0.18, json_path='', seed=2022)
    costs_range = (1, 25)
    valuations_range = (1, 20)
    number_of_tasks_range = (1, 6)
